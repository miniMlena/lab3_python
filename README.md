...
## Вариант: Medium (ключи, компараторы, бенчмарки, генерация тест-кейсов)

Моисеенко Милена Алексеевна, группа М8О-101БВ-25

* **Цель:** Написать функции подсчёта факториала, чисел Фибоначчи и сортировки списков на Python, а также реализовать одну из структур данных (я выбрала очередь). Дополнительно: научиться работать с бенчмарками
